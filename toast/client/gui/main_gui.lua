...
Citizen.CreateThread(function()
	while true do
		...
		if(myPlayer.money ~= nil and myPlayer.money == 0)then
			...
			drawTxt(0.39,0.40,0,0,0.40,"You can Collect $200 every 5 minutes",255,255,255,255)
			drawTxt(0.41,0.44,0,0,0.40,"at your local Welfare Center.",255,255,255,255)
			drawTxt(0.4125,0.48,0,0,0.40,"Jobs will be available soon.",255,255,255,255)
